...
<header id="header" style="background-color: #622050;">
    

    <?php
    NavBar::begin([
        
        'brandLabel' => '<img src="' . Yii::getAlias('@web/img/logo.gif') . '" style="height: 50px;">' , //Yii::$app->name,
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            //['label' => 'Advisors', 'url' => ['/advisor/index']],
